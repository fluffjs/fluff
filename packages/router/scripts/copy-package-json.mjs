...
if (pkg.peerDependencies?.['@fluffjs/cli'])
{
    pkg.peerDependencies['@fluffjs/cli'] = rootPkg.version;
}
if (pkg.peerDependencies?.['@fluffjs/fluff'])
{
    pkg.peerDependencies['@fluffjs/fluff'] = rootPkg.version;
}
